  ...
  return (
    <Wrapper>
      ...
      <Section classes="text-14">
        ...
        <br />
        <br />
        You can easaly create a <span className='bold'>Section</span> like this inside this <span className="bold">.tsx</span> file.
        This could be ideal for a simple intro section.
        <br/><br/>
